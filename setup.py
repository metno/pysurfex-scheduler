...
setup(
    name='pysurfex-scheduler',

    # Versions should comply with PEP440.  For a discussion on single-sourcing
    # the version across setup.py and the project code, see
    # https://packaging.python.org/en/latest/single_source_version.html
    version=get_version("scheduler/__init__.py"),

    description='Python abstraction layer for a scheduling system',
    long_description='Python abstraction layer for a scheduling system like EcFlow',

    # The project's main homepage.
    url='https://github.com/metno/pysurfex-scheduler',
